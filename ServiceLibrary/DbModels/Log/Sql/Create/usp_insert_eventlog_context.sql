...
BEGIN --ATOMIC WITH (TRANSACTION ISOLATION LEVEL = SNAPSHOT, LANGUAGE = N'us_english')
	...
	DECLARE @message_id int = NULL;
	DECLARE @exception_id int = NULL;
	DECLARE @json_id int = NULL;
	...
	/* low priority context data */
	IF @@ROWCOUNT > 0 AND @thread_id IS NOT NULL AND @stack_trace IS NOT NULL
		INSERT INTO Log.Contexts (LogId, ThreadId, StackTrace) VALUES (SCOPE_IDENTITY(), @thread_id, @stack_trace);
